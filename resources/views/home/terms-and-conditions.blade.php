<x-app-layout>
    ...
    <div class="bg-gradient-to-tr from-green-50 via-gray-50 to-primary-100 pb-20">
        <div class="w-[90%] mx-auto py-4 md:py-8 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <a href="https://app.undangly.com/register" class="text-sm font-semibold hover:text-primary py-2 px-2">
                    Daftar
                </a>
            </div>
        </div>
        <x-atoms.wrapper>
            <div class="flex flex-col gap-4">
                <h1 class="text-4xl font-bold text-center py-10">Terms & Conditions</h1>


                <p>Last updated: 2024-09-18</p>
                <p>1. <b>Introduction</b></p>
                <p>Welcome to <b>Undangly</b> (“Company”, “we”, “our”, “us”)!</p>
                <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at
                    <b>https://undangly.com</b> (together or individually “Service”) operated by <b>Undangly</b>.
                </p>
                ...
                <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but
                    please let us know by emailing at <b>undangly.app@gmail.com</b> so we can try to find a solution.
                ...
                <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and
                    ...
                    communications from us by following the unsubscribe link or by emailing at undangly.app@gmail.com.
                </p>
                <p>3. <b>Purchases</b></p>
                <p>If you wish to purchase any product or service made available through Service (“Purchase”), you may
                ...
                <p>We reserve the right to refuse or cancel your order at any time for reasons including but not limited
                ...
                <p>Some parts of Service are billed on a subscription basis ("Subscription(s)"). You will be billed in
                    advance on a recurring and periodic basis ("Billing Cycle"). Billing cycles will be set depending on
                ...
                <p>At the end of each Billing Cycle, your Subscription will automatically renew under the exact same
                    conditions unless you cancel it or Undangly cancels it. You may cancel your Subscription renewal
                    either through your online account management page or by contacting undangly.app@gmail.com customer
                    support team.</p>
                <p>A valid payment method is required to process the payment for your subscription. You shall provide
                    Undangly with accurate and complete billing information that may include but not limited to full
                    name, address, state, postal or zip code, telephone number, and a valid payment method information.
                    By submitting such payment information, you automatically authorize Undangly to charge all
                    Subscription fees incurred through your account to any such payment instruments.</p>
                <p>Should automatic billing fail to occur for any reason, Undangly reserves the right to terminate your
                    access to the Service with immediate effect.</p>
                <p>6. <b>Free Trial</b></p>
                <p>Undangly may, at its sole discretion, offer a Subscription with a free trial for a limited period of
                    time ("Free Trial").</p>
                ...
                <p>If you do enter your billing information when signing up for Free Trial, you will not be charged by
                    Undangly until Free Trial has expired. On the last day of Free Trial period, unless you cancelled
                    your Subscription, you will be automatically charged the applicable Subscription fees for the type
                    of Subscription you have selected.</p>
                <p>At any time and without notice, Undangly reserves the right to (i) modify Terms of Service of Free
                    Trial offer, or (ii) cancel such Free Trial offer.</p>
                <p>7. <b>Fee Changes</b></p>
                <p>Undangly, in its sole discretion and at any time, may modify Subscription fees for the Subscriptions.
                    Any Subscription fee change will become effective at the end of the then-current Billing Cycle.</p>
                <p>Undangly will provide you with a reasonable prior notice of any change in Subscription fees to give
                ...
                <p>8. <b>Refunds</b></p>
                <p>We issue refunds for Contracts within <b>3 days</b> of the original purchase of the Contract.</p>
                <p>9. <b>Content</b></p>
                ...
                <p>Undangly has the right but not the obligation to monitor and edit all Content provided by users.</p>
                <p>In addition, Content found on or through this Service are the property of Undangly or used with
                    ...
                    advance written permission from us.</p>
                ...
                <p>Service and its original content (excluding Content provided by users), features and functionality
                    are and will remain the exclusive property of Undangly and its licensors. Service is protected by
                    copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in
                    connection with any product or service without the prior written consent of Undangly.</p>
                ...
                <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted
                    ...
                    email to undangly.app@gmail.com, with the subject line: “Copyright Infringement” and include in your
                ...
                <p>You can contact our Copyright Agent via email at undangly.app@gmail.com.</p>
                <p>17. <b>Error Reporting and Feedback</b></p>
                <p>You may provide us either directly at undangly.app@gmail.com or via third party sites and tools with
                ...
                <p>Our Service may contain links to third party web sites or services that are not owned or controlled
                    by Undangly.</p>
                <p>Undangly has no control over, and assumes no responsibility for the content, privacy policies, or
                ...
                <p>These Terms shall be governed and construed in accordance with the laws of Indonesia, which governing
                    law applies to agreement without regard to its conflict of law provisions.</p>

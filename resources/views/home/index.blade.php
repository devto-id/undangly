<x-app-layout>
    ...
    <section class="bg-gradient-to-tr from-green-50 via-gray-50 to-primary-100">
        <div class="bg-grid">
            <x-atoms.wrapper>
                <div class="py-[180px]">
    ...
    <section class="bg-slate-100 bg-grid pt-[120px] pb-[60px] mt-[-60px]">
        <x-atoms.wrapper>
            <div class="grid md:grid-cols-3 gap-4">
                ...
                <x-organisms.feature-card title="Hitung Mundur"
                    ...
                    <svg class="h-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 32 32">
                ...
                <x-organisms.feature-card title="Daftar Tamu"
                    ...
                    <svg class="h-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 32 32">
                        <path d="M26 6V2H2v10h9v18h19V6zM4 10V4h20v2H11v4zm24 18H13V8h15z" fill="currentColor"></path>
